...
var notHakeem = !("HakeemOlajuwon"===myName);
...
//unit test. If the param value is 'green' set colorResponse variable
// to 'Green is okay'. If the param value is 'red' set reponse 
//variable to 'I heart red'. Otherwise set the colorResponse variable 
//to 'What is your favorite color?'. Make sure to return the 
...
//parameters, name and number. Have 'greeter' return a string that 
//says something like this 'Hi! I am Bryan and I am 28 years old" but
